...
export default function SignUp() {
  ...
  return (
    <div className="signup-page">
      ...
      {/* Modern Kenyan circle background */}
      <div className="background">
        <div className="ring big red"></div>
        <div className="ring medium green"></div>
        <div className="ring small black"></div>

        <div className="ring big outline-green"></div>
        <div className="ring medium outline-red"></div>
        <div className="ring tiny black"></div>
      </div>
